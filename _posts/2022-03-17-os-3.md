...
<span style="color:#ff5100">운영체제의 커널 주소공간에 각 프로세스의 PCB를 저장하고 있음</script>
<span style="color:#ff5100">항상 프로세스의 문맥을 파악하고 있다가, CPU가 다시 그 프로세스를 점유했을 때, 그 시점부터 실행</script>
